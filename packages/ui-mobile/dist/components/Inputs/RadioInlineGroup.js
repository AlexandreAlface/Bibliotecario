...
export const RadioOptionGroup = ({ label, options, value, onChange, orientation = "horizontal", disabled = false, loading = false, required = false, helperText, errorText, elevated = false, indicator = "paper", testID, accessibilityLabel, style, textColor, }) => {
    ...
    return (_jsxs(Wrapper, { style: [
            ...
            style,
                    ...
                    styles.label,
                    { color: textColor !== null && textColor !== void 0 ? textColor : theme.colors.onPrimary }, // <- usa branco se não for passado outro
                    errorText ? { color: theme.colors.error } : null,
                ], accessibilityLabel: label + (required ? " (obrigatório)" : ""), children: [label, required ? " *" : ""] })), loading ? (_jsx(View, { style: [
                    styles.loader,
                    orientation === "horizontal" && { alignSelf: "flex-start" },
                ], children: _jsx(ActivityIndicator, { accessibilityLabel: "A carregar op\u00E7\u00F5es" }) })) : (_jsx(View, { style: [
                    ...
                    return (_jsxs(Pressable, { onPress: () => !isDisabled && (onChange === null || onChange === void 0 ? void 0 : onChange(opt.value)), style: [
                            ...
                            orientation === "horizontal"
                                ? styles.optionRow
                                : styles.optionColumn,
                        ], accessibilityRole: "radio", accessibilityLabel: (_a = opt.accessibilityLabel) !== null && _a !== void 0 ? _a : opt.label, accessibilityState: { checked, disabled: isDisabled }, disabled: isDisabled, hitSlop: 8, children: [renderIndicator(checked, isDisabled), _jsx(Text, { variant: "titleSmall", style: [
                                    styles.optionLabel,
                                    isDisabled && { opacity: 0.5 },
                                    { color: textColor !== null && textColor !== void 0 ? textColor : theme.colors.onPrimary }, // <- aplica branco
